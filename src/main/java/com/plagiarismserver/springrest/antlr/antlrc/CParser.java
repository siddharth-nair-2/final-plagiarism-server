package com.plagiarismserver.springrest.antlr.antlrc;
...
public class CParser extends Parser {
	...
	public final TypeSpecifierContext typeSpecifier() throws RecognitionException {
		...
		try {
			...
			case Complex:
				...
				setState(456);
				_la = _input.LA(1);
				if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 435736874976280688L) != 0) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final FunctionSpecifierContext functionSpecifier() throws RecognitionException {
		...
		try {
			...
			case Noreturn:
				...
				setState(562);
				_la = _input.LA(1);
				if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 2305843077933171456L) != 0) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final GccAttributeListContext gccAttributeList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & -2L) != 0 || (((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 288230376017494015L) != 0) {
				{
				setState(675);
				gccAttribute();
				}
	...
	public final NestedParenthesesBlockContext nestedParenthesesBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & -2L) != 0 || (((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 1152921504606846973L) != 0) {
				{
				setState(700);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
